...
from dgae_alpha_beta.layers import *
...
DeepModelAE_hidden=32
DeepModelAE_dimension=16

DGAE_alpha_beta_feature_hidden=32
DGAE_alpha_beta_feature_latent=16
...
class LinearModelAE(Model):
    ...
    def _build(self):
        ...
        self.reconstructions = InnerProductDecoder(act = lambda x: x,logging = self.logging)(self.z_mean)
...
class DeepGCNModelAE(Model):
    def __init__(self, placeholders, layers_no,num_features, features_nonzero, **kwargs):
    ...
    def _build(self):
        ...
        for i in np.arange(self.layers_no-1):
            self.hidden_cal_ = GraphConvolution(input_dim = DeepModelAE_hidden,
                                                output_dim = DeepModelAE_hidden,
                                                adj = self.adj,
                                                act = tf.nn.relu,
                                                dropout = self.dropout,
        ...
        self.z_mean = GraphConvolution(input_dim = DeepModelAE_hidden,
                                       output_dim = DeepModelAE_dimension,
                                       adj = self.adj,
                                       act = lambda x: x,
                                       dropout = self.dropout,
                                       logging = self.logging)(self.hidden_cal)
...
#------------------------------------------------------------------------------------------------        
class DGAE_alpha_beta_feature(Model):
    def __init__(self, placeholders, layers_no,num_features, features_nonzero, **kwargs):
        super(DGAE_alpha_beta_feature, self).__init__(**kwargs)
        self.inputs = placeholders['features']
        self.input_dim = num_features
        self.features_nonzero = features_nonzero
        self.adj = placeholders['adj']
    ...
    def _build(self):
        self.hidden1_ = GraphConvolutionSparse(input_dim = self.input_dim,
                                               output_dim = DGAE_alpha_beta_feature_hidden,
                                               adj = self.adj,
                                               features_nonzero = self.features_nonzero,
                                               act = tf.nn.relu,
                                               dropout = self.dropout,
        ...
        self.hidden1_feature = TraditionalLayer_SparseInput(input_dim=self.input_dim,
                                                            ...
                                                            dropout=self.dropout,
                                                            logging=self.logging)(self.inputs)
        self.feature_reconstruction = TraditionalLayer(input_dim=DGAE_alpha_beta_feature_hidden,
        ...
        self.hidden_cal=self.hidden1
        for i in np.arange(self.layers_no-1):
            self.hidden_cal_ = GraphConvolution_Reg(input_dim = DGAE_alpha_beta_feature_hidden,
                                                    output_dim = DGAE_alpha_beta_feature_hidden,
                                                    adj = self.adj,
                                                    act = tf.nn.relu,
                                                    dropout = self.dropout,
        ...
        self.z_mean = GraphConvolution_Reg(input_dim = DGAE_alpha_beta_feature_hidden,
                                           output_dim = DGAE_alpha_beta_feature_latent,
                                           adj = self.adj,
                                           act = lambda x: x,
                                           dropout = self.dropout,
                                           logging = self.logging)(self.hidden_cal)
...
#------------------------------------------------------------------------------------------------
class DGAE_alpha_beta_no_feature(Model):
    def __init__(self, placeholders, layers_no,num_features, num_adj,features_nonzero, **kwargs):
        super(DGAE_alpha_beta_no_feature, self).__init__(**kwargs)
        self.inputs = placeholders['features']
        self.input_dim = num_features
    ...
    def _build(self):
        ...
        self.adj_reconstruction = TraditionalLayer(input_dim=DGAE_alpha_beta_feature_hidden,
