...
from dgae_alpha.layers import *

DGAE_alpha_feature_hidden=32
DGAE_alpha_feature_latent=16
...
class DGAE_alpha_feature(Model):
    ...
    def _build(self):
        self.hidden1_ = GraphConvolutionSparse(input_dim = self.input_dim,
                                               output_dim = DGAE_alpha_feature_hidden,
                                               adj = self.adj,
        ...
        self.feature_reconstruction = TraditionalLayer(input_dim=DGAE_alpha_feature_hidden,
        ...
        for i in np.arange(self.layers_no-1):
            self.hidden_cal_ = GraphConvolution(input_dim = DGAE_alpha_feature_hidden,
                                                output_dim = DGAE_alpha_feature_hidden,
                                                adj = self.adj,
                                                act = tf.nn.relu,
                                                dropout = self.dropout,
        ...
        self.z_mean = GraphConvolution(input_dim = DGAE_alpha_feature_hidden,
                                       output_dim = DGAE_alpha_feature_latent,
                                       adj = self.adj,
                                       act = lambda x: x,
                                       dropout = self.dropout,
                                       logging = self.logging)(self.hidden_cal)
...
class DGAE_alpha_no_feature(Model):
    ...
    def _build(self):
        ...
        self.adj_reconstruction = TraditionalLayer(input_dim=DGAE_alpha_feature_hidden,
