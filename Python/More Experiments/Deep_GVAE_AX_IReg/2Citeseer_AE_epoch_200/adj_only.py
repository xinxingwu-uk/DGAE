...
layers_no=6
data_path="/home1/07913/xwu236/Deep_GVAE_AX_IReg/Datasets/"
path_now="/home1/07913/xwu236/Deep_GVAE_AX_IReg/Layer6/2Citeseer_AE_epoch_200/log/"

dataset='citeseer'
model_name='deep_gcn_vae_resadj_coordinate_VAE'#deep_gcn_vae_resfeature_coordinate_VAE

sys.path.append(r"/home1/07913/xwu236/Deep_GVAE_AX_IReg")
...
from linear_gae.optimizer import OptimizerAE, OptimizerVAE,OptimizerAE_FeatureReconstrution,OptimizerAE_AdjReconstrution,OptimizerVAE_FeatureReconstrution,OptimizerVAE_AdjReconstrution 
...
for loss_coeff_adj_i in np.array([0.005,0.001,0.05,0.01,0.5,0.1,1,1.5,2]):
    for loss_coeff_AE_i in np.array([0.1,0.5,1,1.5,2,0.05,0.01,0.005,0.001]):
        ...
        for seed_i in np.arange(nb_run):
            ...
            elif model_name=='deep_gcn_vae_resfeature_coordinate_VAE':
                model = DeepGCNModelAE_ResFeature_Coordinate_VAE(placeholders, layers_no,num_features, num_nodes,features_nonzero)
            elif model_name=='deep_gcn_vae_resadj_coordinate_VAE':
                model=DeepGCNModelAE_ResAdj_Coordinate_VAE(placeholders, layers_no,num_features, num_adj,num_nodes,features_nonzero)
            else:
            ...
            with tf.name_scope('optimizer'):
                ...
                elif model_name in ('deep_gcn_vae_resfeature_coordinate_VAE'):
                ...
                elif model_name in ('deep_gcn_vae_resadj_coordinate_VAE'):
