...
import sys
sys.path.append(r'/work/07913/xwu236/GVAE')
...
output_path="/work/07913/xwu236/GVAE/6Chameleon_AE/log/"
dataset='chameleon'
task='link_prediction'
model_name='deep18_gcn_vae'
dropout=0.
epochs=200
features_used=False
learning_rate=0.01
...
#--------------------------------------------------------------------------------------------------------------------
# Load data
graph_adjacency_list_file_path = '/work/07913/xwu236/GVAE/Datasets/'+dataset+'/out1_graph_edges.txt'

graph_node_features_and_labels_file_path = '/work/07913/xwu236/GVAE/Datasets/'+dataset+'/out1_node_feature_label.txt'
...
for seed_i in np.arange(nb_run):
    ...
    if model_name == 'gcn_ae':
        ...
        # Deep (3-layer GCN) Graph Variational Autoencoder
        model = Deep6GCNModelVAE(placeholders, num_features, num_nodes,
                                features_nonzero)
    elif model_name == 'deep12_gcn_vae':
        # Deep (3-layer GCN) Graph Variational Autoencoder
        model = Deep12GCNModelVAE(placeholders, num_features, num_nodes,
                                features_nonzero)
    elif model_name == 'deep18_gcn_vae':
        # Deep (3-layer GCN) Graph Variational Autoencoder
        model = Deep18GCNModelVAE(placeholders, num_features, num_nodes,
                                features_nonzero)
    elif model_name == 'deep36_gcn_vae':
        # Deep (3-layer GCN) Graph Variational Autoencoder
        model = Deep36GCNModelVAE(placeholders, num_features, num_nodes,
                                features_nonzero)
    else:
