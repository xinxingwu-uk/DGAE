...
LinearModelVAE_dimension=16

# GAEModelAE
GAEModelAE_hidden=32
GAEModelAE_dimension=16

GAEModelVAE_hidden=32
GAEModelVAE_dimension=16

# Deep3ModelAE
Deep3ModelAE_hidden=32
Deep3ModelAE_dimension=16

Deep3ModelVAE_hidden=32
Deep3ModelVAE_dimension=16
...
class GCNModelVAE(Model):
    ...
    def _build(self):
        ...
        self.z_mean = GraphConvolution(input_dim = GAEModelVAE_hidden,
                                       output_dim = GAEModelVAE_dimension,
                                       adj = self.adj,
                                       act = lambda x: x,
                                       dropout = self.dropout,
                                       logging = self.logging)(self.hidden)

        self.z_log_std = GraphConvolution(input_dim = GAEModelVAE_hidden,
                                          output_dim = GAEModelVAE_dimension,
                                          adj = self.adj,
                                          act = lambda x: x,
                                          dropout = self.dropout,
        ...
        self.z = self.z_mean + tf.random_normal([self.n_samples, GAEModelVAE_dimension]) * tf.exp(self.z_log_std)
...
class LinearModelVAE(Model):
    ...
    def _build(self):
        ...
        self.z_mean = GraphConvolutionSparse(input_dim = self.input_dim,
                                             output_dim = LinearModelVAE_dimension,
                                             adj = self.adj,
                                             features_nonzero=self.features_nonzero,
                                             act = lambda x: x,
                                             dropout = self.dropout,
        ...
        self.z = self.z_mean + tf.random_normal([self.n_samples, LinearModelVAE_dimension]) * tf.exp(self.z_log_std)
...
class DeepGCNModelVAE(Model):
    ...
    def _build(self):
        self.hidden1 = GraphConvolutionSparse(input_dim = self.input_dim,
                                              output_dim = Deep3ModelVAE_hidden,
                                              adj = self.adj,
                                              features_nonzero = self.features_nonzero,
                                              act = tf.nn.relu,
                                              dropout = self.dropout,
        ...
        self.hidden2 = GraphConvolution(input_dim = Deep3ModelVAE_hidden,
                                        output_dim =Deep3ModelVAE_hidden,
                                        adj = self.adj,
                                        act = tf.nn.relu,
                                        dropout = self.dropout,
        ...
        self.z_mean = GraphConvolution(input_dim = Deep3ModelVAE_hidden,
                                       output_dim = Deep3ModelVAE_dimension,
                                       adj = self.adj,
                                       act = lambda x: x,
                                       dropout = self.dropout,
                                       logging = self.logging)(self.hidden2)

        self.z_log_std = GraphConvolution(input_dim = Deep3ModelVAE_hidden,
                                          output_dim = Deep3ModelVAE_dimension,
                                          adj = self.adj,
                                          act = lambda x: x,
                                          dropout = self.dropout,
        ...
        self.z = self.z_mean + tf.random_normal([self.n_samples, Deep3ModelVAE_dimension]) * tf.exp(self.z_log_std)

        self.reconstructions = InnerProductDecoder(act = lambda x: x,
                                                   logging = self.logging)(self.z)
        
#------------------------------------------------------------------------------------------------
class Deep6GCNModelVAE(Model):
    def __init__(self, placeholders, num_features, num_nodes,features_nonzero, **kwargs):
        super(Deep6GCNModelVAE, self).__init__(**kwargs)
...
#------------------------------------------------------------------------------------------------
class Deep12GCNModelVAE(Model):
    def __init__(self, placeholders, num_features, num_nodes,features_nonzero, **kwargs):
        super(Deep12GCNModelVAE, self).__init__(**kwargs)
...
#------------------------------------------------------------------------------------------------
class Deep18GCNModelVAE(Model):
    def __init__(self, placeholders, num_features, num_nodes,features_nonzero, **kwargs):
        super(Deep18GCNModelVAE, self).__init__(**kwargs)
...
#------------------------------------------------------------------------------------------------
class Deep36GCNModelVAE(Model):
    def __init__(self, placeholders, num_features, num_nodes,features_nonzero, **kwargs):
        super(Deep36GCNModelVAE, self).__init__(**kwargs)
