...
for seed_i in np.arange(nb_run):
    ...
    if model_name == 'gcn_ae':
        ...
        model = LinearModelVAE(placeholders, num_features, num_nodes,
                               features_nonzero)
    elif model_name == 'deep6_gcn_ae':
        # Deep (3-layer GCN) Graph Autoencoder
        model = Deep6GCNModelAE(placeholders, num_features, features_nonzero)
    ...
    with tf.name_scope('optimizer'):
        ...
        if model_name in ('gcn_ae', 'linear_ae', 'deep_gcn_ae','deep6_gcn_ae'):
        ...
        elif model_name in ('gcn_vae', 'linear_vae', 'deep_gcn_vae','deep6_gcn_vae'):
