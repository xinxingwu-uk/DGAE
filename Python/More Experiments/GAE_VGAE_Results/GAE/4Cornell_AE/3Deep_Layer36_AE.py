...
write_to_csv(mean_time_.reshape(1,len(mean_time_)),"/home1/07913/xwu236/GAE/4Cornell_AE/log/"+p_model_name+"_time_"+str(features_used)+".csv")

mean_roc_=np.array(mean_roc)
write_to_csv(mean_roc_.reshape(1,len(mean_roc_)),"/home1/07913/xwu236/GAE/4Cornell_AE/log/"+p_model_name+"_roc_"+str(features_used)+".csv")

mean_ap_=np.array(mean_ap)
write_to_csv(mean_ap_.reshape(1,len(mean_ap_)),"/home1/07913/xwu236/GAE/4Cornell_AE/log/"+p_model_name+"_ap_"+str(features_used)+".csv")
